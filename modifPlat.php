...
$requete = $bdd->prepare('SELECT * FROM `plat` WHERE id = :id'); // :id_plats est inventé ici, il doit crspdre au 2ème paramètre de bindParam
...

{
  ...
  echo "<div class='plat'>
    <form method='post' action='traitementUpdatePlat.php?id=".$idPlat."' enctype='multipart/form-data'>
      <p>
